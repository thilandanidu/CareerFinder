 ...
 */
@WebServlet(name = "Servsign", urlPatterns = {"/Servsign"})
public class Servsign extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servsign</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servsign at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a6=request.getParameter("sno");
        String a7=request.getParameter("addres");
        String a8=request.getParameter("university");
        String a9=request.getParameter("cno");
        String a10=request.getParameter("fac");
        String type = "user";
        
        UserClass UC = new UserClass();
        
        if (UC.InsertUser(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)) {
